...
interface Props {
  invoiceFields: InvGenFieldProps | null;
}

const InvGenPreview: React.FC<Props> = ({ invoiceFields }) => {
  if (!invoiceFields) {
    return (
      <div className="text-gray-400 text-sm">
        No invoice data yet. Start by sending a message.
      </div>
    );
  }
