const blogPosts = [
  ...
  },
  {
    ...
    content: [
    "Meet Velqen: your AI finance assistant that actually pulls its weight. With features like AI-powered transaction classification, OCR invoice extraction, and smart record reconciliation, Velqen takes care of the boring stuff.",
    "Need to calculate your tax or figure out how much your company might be worth? Just ask. Velqen’s built-in chatbot makes it quick and painless.",
